...
python ./src/process_log.py  ./src/feature1.py ./src/feature2.py ./src/feature3.py ./src/feature4.py ./log_input/log.txt ./log_output/hosts.txt ./log_output/hours.txt ./log_output/resources.txt ./log_output/blocked.txt
